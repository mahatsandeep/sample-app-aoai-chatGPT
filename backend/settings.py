...
class _UiSettings(BaseSettings):
    ...
    title: str = "TrominoSoft"
    logo: Optional[str] = None
    chat_logo: Optional[str] = None
    chat_title: str = "Start chatting with your AI assistant"
    chat_description: str = "This chatbot is configured to answer your questions on the SOP Documents."
